<footer class="bg-blue-800 text-blue-100 bg-pattern">
	<x-container>
		<div class="py-16 flex justify-between space-x-10">
			<div class="w-1/4">
			...
			<div class="w-1/4">
				...
				<ul class="leading-7">
					<li><a class="hover:text-yellow-400" href="#">About Us</a></li>
					<li><a class="hover:text-yellow-400" href="#">Contact Us</a></li>
					<li><a class="hover:text-yellow-400" href="#">FAQs</a></li>
					<li><a class="hover:text-yellow-400" href="#">Terms & Conditions</a></li>
					<li><a class="hover:text-yellow-400" href="#">Privacy Policy</a></li>
				</ul>
			</div>
			<div class="w-1/4">
				<h5 class="font-semibold mb-4 text-blue-300">FOLLOW US</h5>
				<ul class="flex items-center mb-12 text-yellow-400">

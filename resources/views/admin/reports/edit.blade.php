<x-admin-layout>
    ...
    <div class="flex flex-wrap w-full">
        {!! Form::model($report, ['method' => 'PATCH', 'route' => ['admin.reports.update', $report->id], 'class' => 'flex flex-wrap']) !!}
					...
					<div class="flex flex-wrap">
						<div class="w-full lg:w-6/12 px-4">
							<div class="relative w-full mb-3">
								...
								{!! Form::text('title', null, ['class' => 'border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150']) !!}
							</div>
						</div>
						<div class="w-full lg:w-6/12 px-4">
							<div class="relative w-full mb-3">
						...
						<div class="w-full lg:w-6/12 px-4">
							<div class="relative w-full mb-3">
								...
								{!! Form::text('sku', null, ['class' => 'border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150']) !!}
							</div>
						</div>
						<div class="w-full lg:w-6/12 px-4">
							<div class="relative w-full mb-3">
								{!! Form::label('published', 'Published', ['class' => 'block uppercase text-gray-600 text-xs font-bold mb-2']) !!}
								{!! Form::date('published', $report->getAttributes()['published'], ['class' => 'border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150']) !!}
							</div>
						</div>
						...
						<div class="w-full">
							...
							<div class="w-full lg:w-12/12">
								<div class="relative w-full mb-3">
									...
									{!! Form::select('status', [1 => 'Active', 0 => 'Inactive'], null, ['class' => 'border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150']) !!}	
								</div>
							</div>
						</div>
					</div>
						...
						<div class="w-full">
							...
							<div class="w-full lg:w-12/12">
								<div class="relative w-full mb-3">
									...
									{!! Form::text('meta_title', $report->meta->title, ['class' => 'border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150']) !!}
								</div>
							</div>
							<div class="w-full lg:w-12/12">
								<div class="relative w-full mb-3">
									{!! Form::label('meta_keywords', 'Keywords', ['class' => 'block uppercase text-gray-600 text-xs font-bold mb-2']) !!}
									{!! Form::text('meta_keywords', $report->meta->keywords, ['class' => 'border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150']) !!}
								</div>
							</div>
							<div class="w-full lg:w-12/12">
								<div class="relative w-full mb-3">
									{!! Form::label('meta_description', 'Description', ['class' => 'block uppercase text-gray-600 text-xs font-bold mb-2']) !!}
									{!! Form::textarea('meta_description', $report->meta->description, ['rows' => 4, 'class' => 'border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150']) !!}
								</div>
							</div>
						</div>
					</div>

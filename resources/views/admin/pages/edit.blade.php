<x-admin-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full px-4">
            <a class="mr-4 text-white font-semibold text-sm flex items-center" href="{{ route('admin.pages.index') }}">
    ...
    {!! Form::model($page, ['method' => 'PATCH', 'route' => ['admin.pages.update', $page->id], 'class' => 'flex flex-wrap w-full']) !!}
                    ...
                    <div class="flex flex-wrap" x-data="{ open: false }">
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative w-full mb-3">
								{!! Form::label('name', 'Title', ['class' => 'block uppercase text-gray-600 text-xs font-bold mb-2']) !!}
                        ...
                        <div class="w-full px-4">
							<div class="relative w-full mb-3">
								{!! Form::label('Body', 'Description', ['class' => 'block uppercase text-gray-600 text-xs font-bold mb-2']) !!}
                        ...
                        <div class="w-full">
							...
							<div class="w-full lg:w-12/12">
								<div class="relative w-full mb-3">
									...
									{!! Form::text('meta_title', $page->meta->title, ['class' => 'border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150']) !!}
								</div>
							</div>
							<div class="w-full lg:w-12/12">
								<div class="relative w-full mb-3">
									{!! Form::label('meta_keywords', 'Keywords', ['class' => 'block uppercase text-gray-600 text-xs font-bold mb-2']) !!}
									{!! Form::text('meta_keywords', $page->meta->keywords, ['class' => 'border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150']) !!}
								</div>
							</div>
							<div class="w-full lg:w-12/12">
								<div class="relative w-full mb-3">
									{!! Form::label('meta_description', 'Description', ['class' => 'block uppercase text-gray-600 text-xs font-bold mb-2']) !!}
									{!! Form::textarea('meta_description', $page->meta->description, ['rows' => 4, 'class' => 'border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150']) !!}
								</div>
							</div>
						</div>
                    </div>
